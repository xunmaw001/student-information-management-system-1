            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">缴费表登记</li>
                    </ol>
                </div>
            </div>
        </div>
                    ...
                    <div class="widget-area-2 lochana-box-shadow">
                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 本表所有字段 -->
                                ...
                                <div class="form-group col-md-6">
                                    <label>缴费类型</label>
                                    <input id="jiaofeiValue" name="jiaofeiValue" class="form-control"
                                           v-model="ruleForm.jiaofeiValue" readonly>
                                </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="jiaofeiMoney" name="jiaofeiMoney" class="form-control"
                                               v-model="ruleForm.jiaofeiMoney" readonly>
                                    </div>
